...
class TareasControllerTest < ActionController::TestCase
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post :create, tarea: { desc: @tarea.desc, establecimiento_id: @tarea.establecimiento_id, estado: @tarea.estado, fecha: @tarea.fecha, titulo: @tarea.titulo }
    end
  ...
  test "should update tarea" do
    patch :update, id: @tarea, tarea: { desc: @tarea.desc, establecimiento_id: @tarea.establecimiento_id, estado: @tarea.estado, fecha: @tarea.fecha, titulo: @tarea.titulo }
    assert_redirected_to tarea_path(assigns(:tarea))
  end
