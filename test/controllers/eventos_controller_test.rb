...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { desc: @evento.desc, eventotipo_id: @evento.eventotipo_id, fecha: @evento.fecha, registro: @evento.registro, unidad: @evento.unidad }
    end
  ...
  test "should update evento" do
    patch :update, id: @evento, evento: { desc: @evento.desc, eventotipo_id: @evento.eventotipo_id, fecha: @evento.fecha, registro: @evento.registro, unidad: @evento.unidad }
    assert_redirected_to evento_path(assigns(:evento))
  end
